...
if ( ! function_exists( 'cuthbert_get_filter_items' ) ) {
	/**
	 ...
	 * @return array
	 */
	function cuthbert_get_filter_items( $params ) {
		...
		return apply_filters( 'cuthbert_filter_get_filter_items', $items, $params );
	}
}
